...
describe('Colour', () => {
  ...
  describe('subtraction', () => {
    test('colour - colour', () => {
      const c1 = new Colour(0.9, 0.6, 0.75);
      const c2 = new Colour(0.7, 0.1, 0.25);
      expect(c1.subtract(c2)).shallowEpsilonEquals(new Colour(0.2, 0.5, 0.5));
    });
  ...
  describe('multiplication', () => {
    test('colour * scalar', () => {
      ...
      expect(c1.multiply(2)).shallowEpsilonEquals(new Colour(0.4, 0.6, 0.8));
    });

    test('colour * colour', () => {
      const c1 = new Colour(1, 0.2, 0.4);
      const c2 = new Colour(0.9, 1, 0.1);
      expect(c1.multiply(c2)).shallowEpsilonEquals(new Colour(0.9, 0.2, 0.04));
    });

    test('colour * object', () => {
      const c1 = new Colour(0.9, 0.6, 0.75);
      expect(() => c1.multiply({})).toThrowError(RtError);
    });
  });
});
