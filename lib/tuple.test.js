...
describe('Tuple', () => {
  ...
  test('subtraction: point - vector', () => {
    const p3 = Tuple.point(3, 2, 1);
    const v1 = Tuple.vector(5, 6, 7);
    expect(p3.subtract(v1)).toEqual(Tuple.point(-2, -4, -6));
  });

  test('subtraction: vector - vector', () => {
    const v2 = Tuple.vector(3, 2, 1);
    const v3 = Tuple.vector(5, 6, 7);
    expect(v2.subtract(v3)).toEqual(Tuple.vector(-2, -4, -6));
  });
});
